...
//Database elements
const links = [["RANDOM PASSWORD GENERATOR", "images/rpwg.png", "Random Password Generator is a simple Mobile-First web page to create secure passwords in a lazy way :) ", "https://github.com/ElhadiAyoub/Random-Password-Generator", "projects/Random-Password-Generator/index.html"],
["COUNTDOWN TIMER", "images/cdt.png", "A simple Mobile-First Countdown timer. ", "https://github.com/ElhadiAyoub/CountDown-Timer", "projects/CountDown-Timer/index.html"],
...
["SINGLE PAGE LOGIN FORM", "images/splf.png", "A simple login UI that interacts with the user by dynamically rewriting the current page rather than loading entire new pages from a server.", "https://github.com/ElhadiAyoub/Single-Page-Login-Form", "projects/Single-Page-Login-Form/index.html"],
